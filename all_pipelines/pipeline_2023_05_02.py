...
def build_pipeline():
    """
    Improvement: Backported pipeline improvements from ML4Meta project

    Pipeline Version 2023-05-02
    """
    ...
    camelcut = CamelCut_Stage()
    delimiters = DelimitRE_Stage(r'[^\s\w]')
    stopwords = StopWord_Stage()
    fuzzy_match = FuzzyStringMatching_Stage(0.1, query_len_thresh=3, distance='2023')
